...
def load_train_data():
    ...
    """
    path = BASE_DIR / "data_storage" / "train_test_splits" / "cervical_elongation" / "train_data_60.pkl"
...
def objective(trial):
    ...
    un conjunto de hiperparámetros de RandomForest.
    """
...
def main():
    ...
    print("Iniciando optimización de hiperparámetros con RandomForest...")
    ...
    # Reconstruir el mejor modelo con dichos hiperparámetros
    ...
    print("Entrenamiento completo del modelo final con los mejores hiperparámetros.")


    # Guardar el modelo entrenado
    path = BASE_DIR / "data_storage" / "models" / "cervical_elongation" / "rf"
    joblib.dump(best_model, path / "best_model_60.pkl")
