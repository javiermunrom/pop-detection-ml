...
def load_train_data():
    ...
    """
    path = BASE_DIR / "data_storage" / "train_test_splits" / "cystourethrocele" / "train_data.pkl"
...
def main():
    ...
    joblib.dump(best_model, BASE_DIR /"data_storage" / "models" / "cystourethrocele" / "rf" / "best_model.pkl")
