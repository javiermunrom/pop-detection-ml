...
def load_train_data():
    ...
    """
    path = BASE_DIR / "data_storage" / "train_test_splits" / "any_prolapse" / "train_data.pkl"
...
def main():
    ...
    joblib.dump(best_model, BASE_DIR /"data_storage" / "models" / "any_prolapse" / "rf" / "best_model.pkl")
