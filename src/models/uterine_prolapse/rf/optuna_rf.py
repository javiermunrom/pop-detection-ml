...
def load_train_data():
    ...
    """
    path = BASE_DIR / "data_storage" / "train_test_splits" / "uterine_prolapse" / "train_data.pkl"
...
def main():
    ...
    joblib.dump(best_model, BASE_DIR /"data_storage" / "models" / "uterine_prolapse" / "rf" / "best_model.pkl")
